...
<a href="#">View all Notifications</a>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <button class="btn" style="background:#997045;color:blue;"> &nbsp; &nbsp; <b>Download CSV </b> &nbsp; &nbsp; </button>
            </div>
            <div class="col">
            <label for="">Invoices</label>
            <button type="button" class="btn" style="background:#997045;color:blue;"><b>Download Invoices</b></button>
            </div>
