                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">
                                        <a href="{{ env('BASE_URL') }}"><img
                                                src="{{ asset('assets/img/home-icon.svg')  }}"
                                                alt="Post Author"> Home</a>
                                    </li>
        ...
        <div class="container" style="max-width: 1440px !important;">
            <div class="row">
                <div class="col-md-12 col-lg-4 col-xl-3 theiaStickySidebar" style="border:0px solid red;">
                    <form action="{{ env('BASE_URL') }}category/{{ request()->id }}/influencers/filter">
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-3">
                                <div class="card avatar-one"
                                    ...
                                    <div class="influencer-dev" style="margin:10px;padding:3px;">
                                        <h5 style="font-size:16px;">{{ $influencer ? $influencer->full_name : '' }}<i
