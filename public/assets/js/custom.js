...
$(document).ready(function () {
    ...
    $(".next").click(function () {
        ...
        str2 = "next2";
        str3 = "next3";
        if (!str2.localeCompare($(this).attr('id')) && validate1(0) == false) {
            val2 = false;
        } else {
            val2 = false;
        }
...
/***********************
 * My Working Start Here
 ***********************/

function remove_validation_on_input_change(inputs) {
...
function validate_inputs(form) {
    ...
    inputs.each(function () {
        ...
        if (!input[0].checkValidity() || input.val() === '') {
            ...
            $(form).find(input).parents('.form-group').find('.invalid-feedback').show();
...
function show_img(image = '#image', selector = '#logo') {
