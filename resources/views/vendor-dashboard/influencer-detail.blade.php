...
$influencersByCategory = getInfluencersByCategoryId($influencer->user_professional_detail ?
$influencer->user_professional_detail->category_id : '');
            ...
            <div class="col-md-12 col-lg-4 col-xl-3 theiaStickySidebar gallerys" style="border:0px solid red;">
                ...
                <div class="card search-filter" style="border:0px solid red;">
                    ...
                    <div class="card-header__">
                        <div class="influencer project-img" style="border-radius:4px 4px 0px 0px !important; "
                            id="influencer">
                            <a href="{{ $influencer ? $influencer->influencer_profile_image_main : '' }}">
                                <img class="card-title mb-0"
                                    src="{{ $influencer ? $influencer->influencer_profile_image_main : '' }}"
                                    alt="author" width="100%" height="208px">
                            </a><br />
                        </div>
                        <!-- <lable>Book Talent<i class="fa fa-email"></i></lable> -->
                        <!-- <a href="javascript:void(0);">Clear All</a> -->
                    </div>
                    <div class="card-body" style="background-color:#f2e49c;height: auto; border-radius: 4px!important;">
                        ...
                        <div class="row" style="line-height: 1;">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group linespace">
                                    <span class="badge badge-pill badge-skill">@foreach($influencer->arts as $art){{
                                        getSafeValueFromObject($art, 'art_name') }}<br>@endforeach</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group linespace">
                                    <span class="badge badge-pill badge-skill">
                                        ...
                                        @if(!$langShown)
                                        @if($influencer->personal_information &&
                                        $influencer->personal_information->spoken_language)
                                        {{ $influencer->personal_information->spoken_language->name }}
                                        @elseif($influencer->personal_information &&
                            ...
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{
                                        $influencer->personal_information->ethnicity->name ?? '' }}</span>
                                </div>
                            </div>
                            {{-- <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{
                                        getSafeValueFromObject($influencer->country, 'name') }}</span>
                                </div>
                            </div> --}}
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{
                                        ucfirst(getSafeValueFromObject($influencer->personal_information, 'gender'))
                                        }}</span>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{
                                        getSafeValueFromObject($influencer->personal_information, 'age') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{ $influencer->personal_information ?
                                        Str::ucfirst( $influencer->personal_information->hair_type) : '' }}</span>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{ $influencer->personal_information ?
                                        Str::ucfirst($influencer->personal_information->hair_color) : '' }}</span>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{
                                        ucfirst($influencer->personal_information->eye_color ?? '') }}</span>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{
                                        getSafeValueFromObject($influencer->personal_information, 'height') }} </span>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{
                                        getSafeValueFromObject($influencer->personal_information, 'weight') }}</span>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{
                                        getSafeValueFromObject($influencer->personal_information, 'shoes_size')
                                        }}</span>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{
                                        getSafeValueFromObject($influencer->personal_information, 'clothsize') }}</span>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{ $influencer->personal_information ?
                                        $influencer->personal_information->tattoes : '' }}</span>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group linespace">
                                    <span class="badge badge-pill badge-skill">{{
                                        getSafeValueFromObject($influencer->personal_information,
                                        'willing_to_travel_formatted') }}</span>
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill"
                                        style="width:100%; font-size: 12px !important;">{{formatDateToread($influencer->personal_information->main_available_from_date
                                        ??
                                        '')}}&nbsp;&nbsp;&nbsp;&nbsp;{{formatDateToread($influencer->personal_information->base_date
                                        ?? '')}} --}}
                                        {{-- {{ $main_availability ?
                                        formatDateToread($main_availability->availability_from_date) : '' }} --}}
                                        {{-- </span>
                                </div>
                            </div> --}}
                            {{-- <div class="col-md-6">
                            ...
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                $city = DB::table('cities')->where('id',$influencer->personal_information->city_id
                                )->first();
                                }
                                @endphp
                                <div class="form-group linespace">
                                    <span class="badge badge-pill badge-skill">{{$city->name ?? ''}}
                                    ...
                                    <span class="badge badge-pill badge-skill">{{
                                        formatDateToShowread($main_available_from_date ?? '')}}
                                        {{-- {{ getSafeValueFromObject($influencer->personal_information, 'name') }}
                                        --}}
                                    </span>
                                </div>
                            ...
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                $country =
                                DB::table('countries')->where('id',$influencer->personal_information->country_id)->first();
                                }
                                @endphp
                                <div class="form-group linespace">
                                    <span class="badge badge-pill badge-skill">{{$country->name ?? ''}}
                                        {{-- {{ getSafeValueFromObject($influencer->personal_information, 'name') }}
                                        --}}
                                    </span>

                                    <br>
                                    <span class="badge badge-pill badge-skill">{{formatDateToShowread($base_date ??
                                        '')}}
                                        {{-- {{ getSafeValueFromObject($influencer->personal_information, 'name') }}
                                        --}}
                                    </span>
                            ...
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                $city1 =
                                DB::table('cities')->where('id',$influencer->personal_information->travlling_one_city_id)->first();
                                }
                                }
                                @endphp
                                <div class="form-group linespace">
                                    <span class="badge badge-pill badge-skill">{{$city1->name ?? ''}}
                                        {{-- {{ getSafeValueFromObject($influencer->personal_information, 'name') }}
                                        --}}
                                    </span>
                                    <br>
                            ...
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                $country1 =
                                DB::table('countries')->where('id',$influencer->personal_information->travlling_one_country_id)->first();
                                }
                                @endphp
                                <div class="form-group linespace">
                                    <span class="badge badge-pill badge-skill">{{$country1->name ?? ''}}
                                        {{-- {{ getSafeValueFromObject($influencer->personal_information, 'name') }}
                                        --}}
                                    </span>
                                    <br>
                            ...
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                $city2 =
                                DB::table('cities')->where('id',$influencer->personal_information->travlling_two_city_id)->first();
                                }
                                }
                                @endphp
                                <div class="form-group linespace">
                                    <span class="badge badge-pill badge-skill">{{$city2->name ?? ''}}
                                        {{-- {{ getSafeValueFromObject($influencer->personal_information, 'name') }}
                                        --}}
                                    </span>
                                    <br>
                            ...
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                $country2 =
                                DB::table('countries')->where('id',$influencer->personal_information->travlling_two_country_id)->first();
                                }
                                }
                                @endphp
                                <div class="form-group linespace">
                                    <span class="badge badge-pill badge-skill">{{$country2->name ?? ''}}
                                        {{-- {{ getSafeValueFromObject($influencer->personal_information, 'name') }}
                                        --}}
                                    </span>
                                    <br>
                            ...
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                if($influencer->personal_information !=null){
                                $travlling_three_from_date =
                                $influencer->personal_information->travlling_three_from_date;
                                if($influencer->personal_information->travlling_three_city_id){
                                $city3 =
                                DB::table('cities')->where('id',$influencer->personal_information->travlling_three_city_id)->first();
                                }
                                }
                                @endphp
                                <div class="form-group linespace">
                                    <span class="badge badge-pill badge-skill">{{$city3->name ?? ''}}
                                        {{-- {{ getSafeValueFromObject($influencer->personal_information, 'name') }}
                                        --}}
                                    </span>
                                    <br>
                            ...
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                $country3 =
                                DB::table('countries')->where('id',$influencer->personal_information->travlling_three_country_id)->first();
                                }
                                }
                                @endphp
                                <div class="form-group linespace">
                                    <span class="badge badge-pill badge-skill"
                                        style="margin-bottom: 12px;">{{$country3->name ?? ''}}
                                        {{-- {{ getSafeValueFromObject($influencer->personal_information, 'name') }}
                                        --}}
                                    </span>
                                    <br>
                            ...
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{ $influencer->personal_information &&
                                        $influencer->personal_information->price_negotiable==1 ? "Yes" : " " }}
                                        {{-- {{ getSafeValueFromObject($influencer->user_professional_detail,
                                        'price_formatted') }} --}}
                                    </span>
                                </div>
                            </div>
                            <div class="col-md-6" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-pill badge-skill">{{
                                        getSafeValueFromObject($influencer->personal_information,
                                        'is_collaboration_formatted') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12" style="margin-top: 4px;">
                                ...
                                <div class="form-group">
                                    <p style="text-align:justify;line-height: 1.5rem !important;" class="badge-skill">
                                        {{$influencer->personal_information->price_include ?? ''}}
                                        {{-- {{ getSafeValueFromObject($influencer->user_professional_detail,
                                        'price_include_formatted') }} --}}
                                    </p>
                                </div>
                            </div>
            ...
            <div class="col-md-12 col-lg-8 col-xl-9">
                    ...
                    <ul style="list-style-type: none;">
                        ...
                        <li style="display: inline-block;">
                            <div class="social-wrapper" style="text-align: center;">
                                ...
                                <a href="{{ $instagram ? 'https://' . ltrim($instagram->url, 'https://') : ''}}"
                        ...
                        <li style="display: inline-block;">
                            <div class="social-wrapper" style="text-align: center;">
                                <a href="{{ $twitter ? 'https://' . ltrim($twitter->url, 'https://') : ''}}"
                                    target="_blank" rel="noopener noreferrer">
                        ...
                        <li style="display: inline-block;">
                            <div class="social-wrapper" style="text-align: center;">
                                <a href="{{ $youtube ? 'https://' . ltrim($youtube->url, 'https://') : ''}}"
                                    target="_blank" rel="noopener noreferrer">
                        ...
                        <li style="display: inline-block;">
                            <div class="social-wrapper" style="text-align: center;">
                                <a href="{{ $tiktok ? 'https://' . ltrim($tiktok->url, 'https://') : ''}}"
                                    target="_blank" rel="noopener noreferrer">
                        ...
                        <li style="display: inline-block;">
                            <div class="social-wrapper" style="text-align: center;">
                                <a href="{{ $facebook ? 'https://' . ltrim($facebook->url, 'https://') : ''}}"
                                    target="_blank" rel="noopener noreferrer">
                        ...
                        <li style="display: inline-block;">
                            <div class="social-wrapper" style="text-align: center;">
                                <a href="{{ $snapchat ? 'https://' . ltrim($snapchat->url, 'https://') : ''}}"
                                    target="_blank" rel="noopener noreferrer">
                        ...
                        @if($pinterestProfiles && !empty($pinterestProfiles->followers) && $pinterestProfiles->followers
                        != '0')
                        <li style="display: inline-block;">
                            <div class="social-wrapper" style="text-align: center;">
                                <a href="{{ $pinterestProfiles ? 'https://' . ltrim($pinterestProfiles->url, 'https://') : ''}}"
                                    target="_blank" rel="noopener noreferrer">
                        ...
                        @endif
                        @if($web && !empty($web->followers) && $web->followers != '0')
                        <li style="display: inline-block;">
                            <div class="social-wrapper" style="text-align: center;">
                                <a href="{{ $web ? 'https://' . ltrim($web->url, 'https://') : ''}}" target="_blank"
                ...
                <div class="details" style="margin-top:4px;">
                    <div class="row">
                        ...
                        @endphp
                        <div class="col-md-3"><span style="font-size: 14px;padding:0px 3px;font-weight:bold;">
                                <span>City: </span>
                        ...
                        {{--<div class="col-md-3"><span style="font-size: 14px;font-weight:bold;padding:0px 3px;">Age:
                                {{ getSafeValueFromObject($influencer->personal_information, 'age') }}</span></div>--}}
                    </div>
                </div>
                ...
                {{-- <div class="bootstrap-tags text-start pl-0">--}}
                    {{-- <span class="badge badge-pill badge-skills">Influencer <span class="tag-close" --}} {{--
                            data-role="remove"><i--}} {{-- class="fas fa-times"></i></span></span>--}}
                    {{-- <span class="badge badge-pill badge-skills">USA <span class="tag-close"
                            data-role="remove"><i--}} {{-- class="fas fa-times"></i></span></span>--}}
                    {{-- <span class="badge badge-pill badge-skills">Hourly <span class="tag-close"
                            data-role="remove"><i--}} {{-- class="fas fa-times"></i></span></span>--}}
                    {{-- <span class="badge badge-pill badge-skills">0-1 years <span class="tag-close" --}} {{--
                            data-role="remove"><i--}} {{-- class="fas fa-times"></i></span></span>--}}
                    {{-- <span class="badge badge-pill badge-skills">USD <span class="tag-close"
                            data-role="remove"><i--}} {{-- class="fas fa-times"></i></span></span>--}}
                    {{-- </div>--}}
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-3 gallerys p-3">
                        <div class="avatar-one project-img" style="width:100%;   border-radius:0.3rem !important; ">
                            ...
                            <div class="image-actions">
                                {{-- <a href="{{ $image->file_name_url }}" download class="btn  mr-2"
                                    style="padding: 0;">
                                    <img src="{{ asset('assets/icons/dwnl.png') }}" alt="Download"
                                        style="width: 24px; height: 24px;">
                                </a> --}}

                                <img src="{{ asset('assets/icons/close.png') }}" alt="Delete" class="delete-icon"
                                    data-url="{{ route('influencer.image.delete', ['id' => $image->id]) }}">
                            </div>
                            @endif
                        </div>
                    </div>
