                        ...
                        <div class="card-body" style="background-color:#f2e49c;height: auto;">
                            ...
                            <div class="row" style="line-height: 1;">
                                ...
                                <div class="col-md-6" style="margin-top: 8px;" >
                                    ...
                                    <div class="form-group">
                                        <span
                                            class="badge badge-pill badge-skill">{{ $influencer->personal_information ? Str::upper( $influencer->personal_information->hair_type) : '' }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6" style="margin-top: 8px;" >
                                    ...
                                    <div class="form-group">
                                        <span
                                            class="badge badge-pill badge-skill">{{ $influencer->personal_information ? Str::upper($influencer->personal_information->hair_color) : '' }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6" style="margin-top: 8px;">
                                    ...
                                    <div class="form-group">
                                        <span
                                            class="badge badge-pill badge-skill">{{ getSafeValueFromObject(Str::upper($influencer->personal_information), 'eye_color') }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6" style="margin-top: 8px;">
