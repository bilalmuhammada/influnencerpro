                                    ...
                                    <form id="influencer-register-form">
                                        ...
                                        <div class="alert-div" style="display: none;">
                                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                <div class="alert-text-register" style="font-size: 14px;"> <button
                                        ...
                                        <div class="form-group form-focus">
                                            <input type="text" class="form-control datepicker11 floating" name="age"
                                                id="datepicker11">
                                        ...
                                        <div class="form-group form-focus">
                                            ...
                                            <select name="country_id" class="form-control floating country_id"
                                                id="country_id_influencer">
                                                <option selected hidden disabled value="">&nbsp;&nbsp;</option>
                                            ...
                                            <span class="custom_check">
                                                ...
                                                <span style="font-size: 14px;">
                                                    ...
                                                    <a href="{{ env('BASE_URL') }}/termcondition" target="_blank">Terms
                                                        & Conditions</a> and
                                                    <a href="{{ env('BASE_URL') }}/privacy-policy"
                                    ...
                                    <form id="brand-register-form">
                                        ...
                                        <div class="form-group form-focus">
                                            <input type="text" class="form-control floating "
                                                placeholder="Please provide a valid Business Website." name="website">
                                            {{-- <div class="invalid-feedback">
                                        ...
                                        <div class="form-group form-focus">
                                            <input type="text" class="form-control floating " id="bemail"
                                                placeholder="Please provide a valid Business Email." name="email">
                                        ...
                                        <div class="form-group form-focus">
                                            <input type="text" class="form-control floating position" name="position">
                                            {{-- <div class="invalid-feedback">
                                        ...
                                        <div class="form-group form-focus">
                                            <input type="text" class="form-control datepicker22 floating"
                                                id="datepicker22" name="age">
                                            {{-- <div class="invalid-feedback">
                                        ...
                                        <div class="form-group form-focus mb-0">
                                            <input type="password" class="form-control floating" name="confirm_password"
                                                id="confirm_password_brand">
                                            <div class="input-group-append">
                                                <span class="toggle-password"
                                                    onclick="togglePassword_brand('confirm_password_brand')"
                                                    style="cursor: pointer;">👁️</span>
                                            </div>
                                            {{-- <div class="invalid-feedback">
                                                Please provide a valid Confirm Password.
                                        ...
                                        <div class="row form-row align-items-center" style="margin-top: 20px;">
                                            ...
                                            <div class="col-6 text-end dont-have " style="margin-top: 0;">Already on
                                                influencerPro?<a class="logo-color" href="{{env('BASE_URL').'/login'}}">
                                                    Click here</a></div>
                                        </div>
                                    </form>
                                </div>
