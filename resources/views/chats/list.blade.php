                        ...
                        <div class="chat-cont-left">
                            <div class="row" style="padding:5px 8px;">
                                ...
                                <div class="col-md-2" style="margin-left: -97px;">
                                    <select class="form-select" id="filter-dropdown" style="width: 177%; padding: 0; border:transparent !important">
...
@endphp
                                            <div class="media-body flex-grow-1">
                                                <div
                                                    class="user-name"><b>{{ getSafeValueFromObject($chat->other_user, 'name') }} - <b>{{ $categoryNames ?? ''}} {{ getSafeValueFromObject($chat->other_user, 'company_name') }}</b></div>
