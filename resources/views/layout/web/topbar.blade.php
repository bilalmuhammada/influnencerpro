...
<script>
    ...
    function formatOption(option) {
        ...
        if (flagUrl) {
        return $('<span style="font-size:15px;font-weight:bold;  white-space: nowrap;  padding:8px;"><img src="' + flagUrl + '" class="img-flag" style="width: 20px; height:14px; margin-right: 9px;" /> ' + option.text + '</span>');
    } else {
        ...
        return $('<span style="font-size:15px;font-weight:bold;    white-space: nowrap; padding:8px;">' +
