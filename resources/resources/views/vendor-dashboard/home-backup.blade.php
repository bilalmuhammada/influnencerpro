        ...
        <div class="container" style="max-width: 1440px !important;">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-8 col-xl-9">
                    ...
                    {{--                                    class="fas fa-times"></i></span></span>--}}
                    {{--                    </div>--}}
                    <div class="row" id="infulecer-show" style="border:1px solid red;">
                        @forelse($influencers as $influencer)
                            <div class="col-md-3 col-lg-3 col-xl-3 influencer-box mx-auto" style="border:1px solid red;">
                                <div class="card avatar-one"
                                     style="border:1px solid #997045;width:200px;box-shadow:1px 1px 1px 1px #eee;">
                                    <a href="{{ env('BASE_URL') }}influencers/{{ $influencer->id }}/detail">
                                        <div class="start"
                                            ...
                                            <i class="fas fa-check-circle main-icon"
                                               style="background-color:#fff;padding:7px;border-radius:50%; color: {{ hasFavoritedInfluencers($influencer->id, session()->get('User')->id) == false ? '#999' : 'green' }} !important;"></i>
                                               &nbsp;
                                        </div>
