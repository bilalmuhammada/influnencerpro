    ...
    <section class="contents">
        ...
        <div class="container-fluid" style="border-top:0px solid #eee;height:auto;">
            <div class="col-md-12 col-lg-12">
                <div class="row">
                    <div class="mySlides" style="padding-top:100px;background-color:#997045;height:500px;">
                        <div class="row">
                            <div class="col-md-8 col-lg-7">
                                <div class="banner-content aos" data-aos="fade-up"
                                     style="padding:2%;border-radius:2%;width:100%;margin-left:50px;line-height:20%;margin-top:100px;">
                                    <div class="rating d-flex" style="border:0px solid red;">
                                        ...
                                        <i class="fas fa-star checked"></i>
                                        <i class="fas fa-star checked"></i>
                                        <h5 style="color:#fff;">Trusted by over 2Mm+ users</h5>
                                    </div>
