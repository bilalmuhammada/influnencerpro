            ...
            <div class="project-chart">
                <div class="row">
                    <div class="subscribe-employe" style="padding:10px 0px 10px 0px;">
                        <ul>
                            {{--                                <li class="active"><a href="{{env('BASE_URL') .'vendor/reports/my-reports'}}">Administrator </a>--}}
                            {{--                                </li>--}}
                            @if(session()->get('role') == 'vendor')
                                <li>
                                    {{--                                    {{env('BASE_URL') .'vendor/reports/vendors-earning'}}--}}
                                    <a href="javascript:void(0)">Vendor</a>
                                </li>
                            @else
                                <li>
                                    {{--                                    {{env('BASE_URL') .'vendor/reports/influencer-earning'}}--}}
                                    <a href="javascript:void(0)s">Influencers</a></li>
                                </li>
                            @endif
                        </ul>
                    </div>
