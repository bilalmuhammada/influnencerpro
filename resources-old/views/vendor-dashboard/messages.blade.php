                                    ...
                                    <a href="javascript:void(0);" class="media d-flex">
                                        <div class="media-img-wrap flex-shrink-0">
                                            <div class="avatar avatar-away">
                                                <img src="{{ asset('assets/img/img-02.jpg')}}" alt="User Image"
                        ...
                        <div class="chat-cont-right">
                            <div class="chat-header">
                                ...
                                <div class="media d-flex">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar-online">
                                            <img src="{{ asset('assets/img/img-05.jpg')}}" alt="User Image"
                                                 class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body flex-grow-1">
                            ...
                            <div class="chat-footer" style="border:1px solid #999;">
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-primary msg-send-btn rounded-pill"><i
