        ...
        <div class="col-md-12">
                              <div class="inner-data" style="padding:15px;">
                                <div class="row">
                                    ...
                                    <i class="fa fa-heart" style="border-radius:14px;border:1px solid #000;padding:5px;"></i>
                                    </div>
                                </div>
                                
                                <div class="text-muted" style="margin-top:-10px;"><small>Posted 60 seconds ago</small></div>
                                <span style="font-size:13px;">Payment Verified &nbsp; <i class="fa fa-star filled"></i><i class="fa fa-star filled"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></span>
                                ...
                                <br/>
                                <br/>
                                <div class="text-muted" style="margin-top:;"><h5>Hourly-intermediate-Est. time: Less than 1 month, Less than 30 hrs/week</h5></div>
                                <p>
