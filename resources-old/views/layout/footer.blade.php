        ...
        <div class="col-lg-12 col-md-12 col-12 m-10" style="border:0px solid red;">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 col-6">
                    <img src="{{ asset('assets/img/icon/icons/cells.png') }}" alt=" ">
                </div>
                <div class="col-lg-2 col-md-6 col-6">
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    ...
                    <!-- <div class="footer-bottom-logo">
                        ...
                        <ul>
                            <li><a href="{{ env('BASE_URL') }}"><i class="fas fa-angle-right me-1"></i>Home11</a></li>
                    ...
                    <div class="footer-widget footer-menu">
                        ...
                        <ul>
                            <li><a href="#" class="icon" target="_blank"><img
                                        ...
                                        height="30"></a></li>
                            <li><a href="#" class="icon" target="_blank"><img
                                        src="{{ asset('assets/img/icon/icons/instagram-1-svgrepo-com.svg') }}"
                                        alt="insta" width="30"
                                        height="30"></a></li>
                            <li><a href="#" class="icon" target="_blank"><img
